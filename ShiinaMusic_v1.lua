...
--  FIX v2: headers Cobalt v10, check StatusCode,
--           soporte data.audio, filenameStyle
-- ══════════════════════════════════════════════
local function getCobaltAudio(videoId, callback)
    ...
    local function tryNext()
        ...
        local function attempt(mode)
            ...
            if data.url   then return data.url   end
            if data.audio then return data.audio end
            return nil
        end
